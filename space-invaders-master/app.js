document.addEventListener('DOMContentLoaded', () => {
    ...
    alienInvaders.forEach(invader => squares[currentInvaderIndex + invader].classList.add('enemy'))
    ...
    function moveInvaders() {
        ...
        for (let i = 0; i < alienInvaders.length; i++) {
            squares[alienInvaders[i]].classList.remove('enemy')
        }
        for (let i = 0; i < alienInvaders.length; i++) {
        ...
        for (let i = 0; i < alienInvaders.length; i++) {
            ...
            if (!alienInvadersTakenDown.includes(i)) {
                squares[alienInvaders[i]].classList.add('enemy')
            }
        }
